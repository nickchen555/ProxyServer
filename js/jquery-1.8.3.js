...
define("vendor.asset.jquery/getobject", ['vendor.asset.jquery/jquery'], function (jQuery) {
this.jQuery = jQuery;
//-----------------------------------------------------------------
...
define('vendor.asset.jquery/plugins/jquery.fullscreen', ['vendor.asset.jquery/jquery'], function (jQuery) {
  this.jQuery = jQuery;
...
﻿define('vendor.asset.jquery/plugins/jquery.hoverIntent', ['vendor.asset.jquery/jquery'], function (jQuery) {
  this.jQuery = jQuery;
 ...
 define("vendor.asset.jquery/jquery.ie.cors", ['vendor.asset.jquery/jquery'], function (jQuery) {
//-----------------------------------------------------------------
...
(function (jQuery) {
    ...
    if (!('__jquery_xdomain__' in jQuery)
        ...
        jQuery['__jquery_xdomain__'] = jQuery.support.cors = true;
                ...
                _done = function (state, code) {
                    ...
                    if (!self.responseType) {
                        ...
                        if (_mime.match(/\/json/)) {
                            ...
                            if (jQuery(dom).children('error').length != 0) {
                                $error = jQuery(dom).find('error');
...
define('vendor.asset.jquery/plugins/jquery.resizestop', ['vendor.asset.jquery/jquery'], function (jQuery) {
  this.jQuery = jQuery;
  /**
...
define('quotes.asset.common/tealium', [
  'vendor.asset.jquery/jquery'
], function ($) {
  var tealium = {

    _TEALIUM_LINK : {
      "localhost.wsj.com" : "http://tags.tiqcdn.com/utag/wsjdn/wsjquotes/dev/utag.js",
      "quotes.f.dev.wsj.com" : "//tags.tiqcdn.com/utag/wsjdn/wsjquotes/dev/utag.js",
      "quotes.s.dev.wsj.com" : "//tags.tiqcdn.com/utag/wsjdn/wsjquotes/qa/utag.js",
      "quotes.wsj.com" : "//tags.tiqcdn.com/utag/wsjdn/wsjquotes/prod/utag.js"
    },

    init: function () {
      if (this._TEALIUM_LINK[document.domain]) {
        $.ajaxSetup({ cache: true });
        $.getScript(this._TEALIUM_LINK[document.domain]);
...
/*jshint white:true, evil:false, onevar:false, undef:true, laxcomma:true, forin:true, noarg:true, noempty:true, eqeqeq:true, bitwise:true, undef:false, unused:false, curly:true, devel:true, indent:2, maxerr:50 */
/*global setTimeout, console, define, navigator, screen, window*/
define('quotes.asset.common/chgDomain', [
  'vendor.asset.jquery/jquery'
], function ($) {
  var chgDomain = {

    init: function () {
      $('a.hat-link').each(function () {
        $(this).attr("href", function (index, old) {
          //console.log('old : ', old);
          var re = /quotesore|quotesvir|quotesnew/gi;
          return old.replace(re, "online");
        });
      });
